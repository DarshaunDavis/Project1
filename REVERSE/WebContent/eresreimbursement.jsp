        ...
        <header class="py-3 mb-4 border-bottom">
            ...
            <header class="d-flex justify-content-center py-3">
              <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="eresreimbursement.jsp" class="nav-link active" aria-current="page">Resolved</a></li>
      		...
      		<div class="p-5 text-center table-responsive">
	          			<table class="align-top table table-light table-striped table-hover">
	          				...
	          				try{
	          					...
	          					String sql = "select * from testExpenses where not expenseStatus = 'Pending' and expenseID =" + employeeIDString;
