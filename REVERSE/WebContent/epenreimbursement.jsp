...
<html lang="en">
  <head>
    ...
    <title>Review Reimbursements | Revature: Expense Reimbursement System - Enterprise</title>
        ...
        <header class="py-3 mb-4 border-bottom">
            ...
            <header class="d-flex justify-content-center py-3">
              <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="epenreimbursement.jsp" class="nav-link active" aria-current="page">Review</a></li>
      		...
      		<div class="p-5 text-center table-responsive">
	          			<table class="align-top table table-light table-striped table-hover">
	          				...
	          				try{
	          					...
	          					String sql = "select * from testExpenses where expenseStatus = 'Pending' and expenseID =" + employeeIDString;
